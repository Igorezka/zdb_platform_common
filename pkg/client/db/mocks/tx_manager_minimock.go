...
//go:generate minimock -i github.com/igorezka/zdb_platform_common/pkg/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/igorezka/zdb_platform_common/pkg/client/db"
)
