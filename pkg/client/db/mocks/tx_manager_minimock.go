...
//go:generate minimock -i github.com/igorezka/auth/internal/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/igorezka/auth/internal/client/db"
)
